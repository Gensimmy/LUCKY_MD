import fs from 'fs';
  ...
  export default {
      ...
      description: 'Displays the FEE-XMD command menu',
      run: async (context) => {
          ...
          try {
              ...
              await client.sendMessage(m.chat, { audio: audioBuffer, ptt: true, mimetype: 'audio/mpeg', fileName: 'fee-menu.m4a' }, { quoted: fq });
          } catch {
              await client.sendMessage(m.chat, { audio: { url: randomFile }, ptt: true, mimetype: 'audio/mpeg', fileName: 'fee-menu.m4a' }, { quoted: fq });
          }
      },
  };
